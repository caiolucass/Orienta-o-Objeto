...
namespace Ex33Lab2{	
	public class Pessoa {
        ...
        public void mostrar ( Pessoa[] p, int x ){
            Console.WriteLine( x + " pessoas registradas: ");
            for ( int i = 0; i < x; i++){
            Console.WriteLine(" \nPessoa ( " +(i+1)+" ):"); 
            Console.WriteLine(" Data de Nascimento: "+ p[i].Dia +"/"+ p[i].Mes +"/" + p[i].Ano );
            Console.WriteLine(" Peso: " + p[i].Peso + "\tAltura: " + p[i].Altura );
            }//fim for 
        }
